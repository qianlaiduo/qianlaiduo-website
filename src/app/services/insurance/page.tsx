        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              {
                q: '医疗险免赔额是多少？',
                a: '不同产品免赔额不同，常见有 0 免赔、1 万免赔等。0 免赔产品保费稍高但理赔门槛低，1 万免赔产品保费更实惠。我会根据你的预算和需求推荐合适的方案。',
              },
              {
                q: '理赔需要多久？',
                a: '材料齐全的情况下，一般 3-10 个工作日完成审核。小额理赔（1 万元以下）通常更快，部分公司支持闪赔，最快当天到账。复杂案件可能需要补充材料，时间会稍长。',
              },
              {
                q: '投保前需要体检吗？',
                a: '不一定。年龄较小、保额不高、健康状况良好的客户通常免体检。超过一定年龄或保额，或者有健康告知异常，可能需要体检。具体以保险公司要求为准。',
              },
              {
                q: '续保条件怎么样？',
                a: '医疗险续保是关键。我会优先推荐保证续保的产品（如保证续保 20 年），避免因理赔或健康变化被拒保。投保前会详细说明续保条件，让你明明白白选择。',
              },
              {
                q: '家庭投保有优惠吗？',
                a: '有的。很多产品支持家庭单投保，共享免赔额，保费更优惠。部分产品还有家庭折扣，2 人投保 95 折，3 人及以上 9 折。我会帮你计算最优方案。',
              },
            ].map((item, index) => (
              <div
                key={index}
